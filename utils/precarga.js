...
function precargarDatos(system)
{
    ...
    // Atajos para conciertos (para crear reservas)
    ...
    // Helper para registrar reserva y mantener consistencia si está aprobada
    function registrarReserva(reserva)
    {
        ...
        if (reserva.estado === "aprobada")
        {
            ...
            if (reserva.cliente.saldo >= total && reserva.concierto.cupos >= reserva.cantidad)
            {
            ...
            {
                // Si por algún motivo no hay saldo/cupos suficientes, degradar a pendiente para no romper consistencia
                reserva.estado = "pendiente";
            }
        }
    }

    // 10 reservas en distintos estados
